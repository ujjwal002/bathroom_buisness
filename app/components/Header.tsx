...
export default function Header() {
    ...
    return (
        <header className={`sticky top-0 z-50 w-full transition-all duration-300 ${isScrolled ? 'bg-white/98 backdrop-blur-sm shadow-lg py-1' : 'bg-white/95 '
            }`}>
                ...
                <nav className="flex items-center justify-between py-4">
                    ...
                    <div className="hidden md:flex items-center space-x-1">
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute left-0 mt-1 w-96 bg-white rounded-lg shadow-2xl py-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 border border-gray-100 transform origin-top scale-95 group-hover:scale-100 overflow-hidden">
                                <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 px-4">
                                    ...
                                    <p className="text-sm text-blue-100 mt-1">Professional bathroom solutions tailored to your needs</p>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-0">
                                    ...
                                    >
                                        ...
                                        <div>
                                            <h4 className="font-medium text-gray-900 group-hover/item:text-blue-600 transition-colors">Bathroom Remodeling</h4>
                                            <p className="text-sm text-gray-500 mt-1">Complete renovation solutions for your dream bathroom</p>
                                        </div>
                                    </Link>
                                    ...
                                    >
                                        ...
                                        <div>
                                            <h4 className="font-medium text-gray-900 group-hover/item:text-blue-600 transition-colors">Tub Replacement</h4>
                                            <p className="text-sm text-gray-500 mt-1">Upgrade your bathtub with modern, elegant solutions</p>
                                        </div>
                                    </Link>
                                    ...
                                    >
                                        ...
                                        <div>
                                            <h4 className="font-medium text-gray-900 group-hover/item:text-blue-600 transition-colors">Shower Conversion</h4>
                                            <p className="text-sm text-gray-500 mt-1">Convert your tub to a modern walk-in shower</p>
                                        </div>
                                    </Link>
                                    ...
                                    >
                                        ...
                                        <div>
                                            <h4 className="font-medium text-gray-900 group-hover/item:text-blue-600 transition-colors">Walk-in Tubs</h4>
                                            <p className="text-sm text-gray-500 mt-1">Safe, accessible bathing solutions for all mobility needs</p>
                                        </div>
                                    </Link>
                                </div>
                        ...
                        <Link
                            href="/blogs"
                            className={`px-4 py-2 rounded-md text-gray-800 font-medium transition-all relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 hover:after:w-full after:transition-all after:duration-300 ${activeLink === '/blogs'
                                ? 'text-blue-600 after:bg-blue-600 after:w-full hover:text-blue-700 hover:bg-blue-50'
                                : 'hover:text-blue-600 after:bg-blue-600 hover:bg-gray-50'
                                }`}
            ...
            >
                ...
                {/* Services accordion in mobile menu - ENHANCED */}
                <div>
                    <button
                        onClick={() => setServicesDropdownOpen(!servicesDropdownOpen)}
                    ...
                    <div className={`py-1 bg-gray-50 rounded-md mb-2 overflow-hidden transition-all duration-300 ${servicesDropdownOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'
                        }`}>
                        {/* Premium mobile service items */}
                        <Link
                            href="/services/bathroom-remodeling"
                        ...
                        <Link
                            href="/services/tub-replacement"
                            className={`flex items-center px-4 py-3 hover:bg-blue-50 transition-all ${activeLink === '/services/tub-replacement' ? 'text-blue-600 font-medium' : 'text-gray-700 hover:text-blue-600'
                                }`}
                            onClick={() => {
                                setMobileMenuOpen(false);
                ...
                <Link
                    href="/gallery"
                    className={`block py-3 hover:text-blue-600 border-b border-gray-100 transition-all hover:pl-2 ${activeLink === '/gallery' ? 'text-blue-600 font-medium' : 'text-gray-800'
                        }`}
                    onClick={() => {
                        setMobileMenuOpen(false);
                ...
                <Link
                    href="/about"
                    className={`block py-3 hover:text-blue-600 border-b border-gray-100 transition-all hover:pl-2 ${activeLink === '/about' ? 'text-blue-600 font-medium' : 'text-gray-800'
                        }`}
                    onClick={() => {
                        setMobileMenuOpen(false);
                        setActiveLink('/about');
                ...
                <Link
                    href="/blog"
                    className={`block py-3 hover:text-blue-600 border-b border-gray-100 transition-all hover:pl-2 ${activeLink === '/blog' ? 'text-blue-600 font-medium' : 'text-gray-800'
                        }`}
                    onClick={() => {
                        setMobileMenuOpen(false);
                        setActiveLink('/blog');
                ...
                <Link
                    href="/contact"
                    className={`block py-3 hover:text-blue-600 border-b border-gray-100 transition-all hover:pl-2 ${activeLink === '/contact' ? 'text-blue-600 font-medium' : 'text-gray-800'
                        }`}
                    onClick={() => {
                        setMobileMenuOpen(false);

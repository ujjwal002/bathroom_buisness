...
import { Star, Check, Phone, ArrowRight, Clock, MessageCircle, ChevronRight, Shield, Award, ThumbsUp, ArrowDown } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <Link href="tel:+1234567890" className="border-2 border-white text-white hover:bg-white/10 px-8 py-4 rounded-md text-lg font-semibold transition-all duration-300 flex items-center justify-center">
              ...
              <div className="flex items-center space-x-4">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4, 5].map((n) => (
                    <div key={n} className="w-10 h-10 rounded-full border-2 border-white bg-blue-300 overflow-hidden">
            ...
            <div className="relative hidden lg:block">
              <div className="bg-white p-3 rounded-lg shadow-2xl transform rotate-1 w-full max-w-md mx-auto">
                <img 
            ...
            <div className="inline-flex bg-gray-100 rounded-lg p-1">
              <button 
                className={`px-6 py-2 rounded-md text-sm font-medium transition-colors ${
                  activeTab === 'before-after' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:text-gray-900'
                }`}
              ...
              <button 
                className={`px-6 py-2 rounded-md text-sm font-medium transition-colors ${
                  activeTab === 'recent-projects' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:text-gray-900'
                }`}
